...
public class VideoOps
    ...
    public void onConfiguration(Activity activity,
        ...
        mVideosList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent intent = new Intent(VideoDetailActivity.ACTION_VIDEO_DETAIL);
				intent.putExtra(VideoDetailActivity.VIDEO_DATA, mAdapter.getItem(position));
    ...
    public void getVideoList(){
    	Log.d(TAG, "getVideoList(): get video list");
