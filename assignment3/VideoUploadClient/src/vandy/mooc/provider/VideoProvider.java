...
public class VideoProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri,
        ...
        case VIDEOS:
            ...
            long id = db.insert(VideoContract.VideoEntry.TABLE_NAME,
            					null,
            					values);
    ...
    public int update(Uri uri,
        ...
        case VIDEOS:
            ...
            rowsUpdated = db.update(VideoContract.VideoEntry.TABLE_NAME,
            						values, 
            						selection, 
            						selectionArgs);
            break;
    ...
    public int delete(Uri uri,
        ...
        case VIDEOS:
            ...
            rowsDeleted = db.delete(VideoContract.VideoEntry.TABLE_NAME,
									selection, 
									selectionArgs);
            break;
        default:
