...
public class VideoController {
    ...
    */
    ...
    private VideoProviderHelper mVideoProvider;
    ...
    public VideoController(Context context) {
        ...
        mVideoProvider = new VideoProviderHelper(mContext);
        
        // Initialize the VideoServiceProxy.
        mVideoSvcApi = new RestAdapter
            .Builder()
        ...
        try{
	        ...
	        if (androidVideo != null) {
	            ...
	            if (receivedVideo != null) {
	                ...
	                VideoClient video = new VideoClient(receivedVideo);
	                video.setFilepath(filePath);
	                mVideoProvider.addVideo(video);
    ...
    public String downloadVideo(long videoId) {
    	Response response;
    	try{
    		response = mVideoSvcApi.getData(videoId);
    	}catch(RetrofitError e)
    	{
    		return null;
    	}
    	...
    	{
    		try {
				 file= VideoStorageUtils.storeVideoInExternalDirectory(mContext, 
						response.getBody().in(), String.valueOf(videoId));
    ...
    public List<Video> getVideoList() {
    	...
    	try{
    		return (ArrayList<Video>) mVideoSvcApi.getVideoList();
    	}
    	catch(RetrofitError e)
	    {
	    	return null;
    ...
    public Video rateVideo(long id, double rating)
    {
    	try{
    		return mVideoSvcApi.rateVideo(id, rating);
	    }
		catch(RetrofitError e)
	    {
	    	return null;
